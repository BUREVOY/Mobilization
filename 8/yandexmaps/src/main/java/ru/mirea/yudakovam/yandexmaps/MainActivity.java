package ru.mirea.yudakovam.yandexmaps;
...
import ru.mirea.yudakovam.yandexmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMap().move(
                new CameraPosition(new Point(55.671905, 37.478550), 11.0f, 0.0f,
                        0.0f),
