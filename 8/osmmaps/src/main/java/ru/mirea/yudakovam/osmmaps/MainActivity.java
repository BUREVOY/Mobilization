package ru.mirea.yudakovam.osmmaps;
...
import ru.mirea.yudakovam.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void funcAll(){
        ...
        setMarker("Корпус Е", new GeoPoint(55.671905, 37.478550));
        setMarker("Стромынка", new GeoPoint(55.794229, 37.700772));
        setMarker("Красная площадь", new GeoPoint(55.754024, 37.620275));
